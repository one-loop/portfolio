...
export const RoomModel = () => {
  ...
  useEffect(() => {
    ...
    loader.load("/clean-room-model.glb", (gltfScene) => { // 2 MB
      ...
      // const geometry = new THREE.BoxGeometry(1.5, 1.5, 0.7);
      // const deskHoverObject = new THREE.Mesh( geometry ); 
      // deskHoverObject.name = 'desk hover';
      // deskHoverObject.material.visible = false;
      // // model.add(deskHoverObject);
      // deskHoverObject.position.set(-0.15, 0.5, -1.45);
      // console.log(deskHoverObject);
      ...
      const moveModel = (event: { clientX: number; clientY: number; }) => {
        ...
        model.rotation.z = mouse.y * 0.1;
        model.rotation.x = mouse.y * -0.1;
      }
