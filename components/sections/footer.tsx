...
export const Footer = () => (
  <footer className="text-md text-primary-text text-center py-10 border-t border-transparent-white">
    <p>
      <Link href="https://raw.githubusercontent.com/one-loop/portfolio/main/components/humans.txt" target="_blank" className="text-off-white hover:text-primary-text [transition:color_0.2s] text-sm">Developed by Saad Sifar</Link>
    </p>
