...
const FeatureGrid = ({ features }: FeatureGridProps) => {
    return (
      <Container>
        <div className="grid w-full grid-cols-2 place-items-center gap-y-9 text-sm text-primary-text md:grid-cols-3 md:text-md">
...
const FeatureCards = ({ features }: FeatureCardsProps) => {
    return (
      <Container>
        <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2 md:mt-[14rem] mt-16">
