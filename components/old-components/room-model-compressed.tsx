...
//   // dracoLoader.setDecoderPath( require.resolve("@loaders.gl/draco/draco/") );
...
// export default function RoomModelCompressed() {
//   return (
//     <>
...
//             <Canvas shadows dpr={window.devicePixelRatio} camera={{ position: [6.8, 5.4, 6.4], fov: 50, aspect: 1 }} className="md:!max-w-[800px] md:!max-h-[800px] md:!h-full md:!w-full cursor-grabbing relative">
